...
class EpubCFI {
  constructor(cfiFrom, base, ignoreClass) {
    ...
    if (type === "string") {
      ...
      // const a = this.fromRange(cfiFrom, this.base, ignoreClass);
      // console.log("range a", a);
      // const b = extend(this, a);
      // console.log("range extend", b);
      // return b;
  ...
  pathTo(node, offset, ignoreClass) {
    ...
    while (this.checkValidPath(currentNode)) {
      if (ignoreClass) {
  ...
  walkToNode(steps, _doc, ignoreClass) {
    ...
    var container = doc.documentElement || doc;
    var children;
    var step;
