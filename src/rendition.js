...
class Rendition {
  ...
  */
  ...
  passEvents(contents) {
    ...
    contents.on(EVENTS.CONTENTS.SELECTED, (d, e) => {
      // console.log('passEvents', d, e);
      this.triggerSelectedEvent(d, contents, e);
    });
  }
   ...
   */
  triggerSelectedEvent(cfirange, contents, e) {
    /**
     ...
     * @memberof Rendition
     */
    // console.log("triggerSelectedEvent", cfirange, contents, e);
    this.emit(EVENTS.RENDITION.SELECTED, cfirange, contents, e);
  }
